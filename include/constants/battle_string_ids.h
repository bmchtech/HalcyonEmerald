...
#define STRINGID_EJECTBUTTONACTIVATES 567
#define STRINGID_REDCARDACTIVATES 568
#define STRINGID_PKMNANCHOREDITSELFREDCARD 569
#define STRINGID_PKMNANCHORSITSELFWITHREDCARD 570

...
#define FLAG_HIDDEN_ITEM_ROUTE_117_MAWILITE                  (FLAG_HIDDEN_ITEMS_START + 0x48)
...
#define FLAG_HIDDEN_ITEM_SEASPRAY_CAVE_B1F_ICICLE_PLATE      (FLAG_HIDDEN_ITEMS_START + 0x5F)
#define FLAG_HIDDEN_ITEM_SEASPRAY_CAVE_B1F_ICE_STONE         (FLAG_HIDDEN_ITEMS_START + 0x60)

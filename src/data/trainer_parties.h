...
static const struct TrainerMonItemCustomMoves sParty_BrendanRoute119Mudkip[] = {
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_STONE_EDGE, MOVE_OUTRAGE, MOVE_CRUNCH, MOVE_DRAGON_DANCE
    },   
    {
    .lvl = 2,
...
static const struct TrainerMonItemCustomMoves sParty_MayRoute119Mudkip[] = {
    ...
    .ability = 0, // Guts
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_BRAVE_BIRD, MOVE_DOUBLE_EDGE, MOVE_REVERSAL, MOVE_PROTECT
    },
    {
    .lvl = 0,
    .species = SPECIES_STARMIE,
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_OUTRAGE, MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_DRAGON_DANCE
    },
    {
    .lvl = 2,
    .species = SPECIES_SCEPTILE,
...
static const struct TrainerMonItemCustomMoves sParty_MayLilycoveTreecko[] = { // May Lilycove
    {
    .iv = 150,
    .lvl = 31,
    .species = SPECIES_TROPIUS,
...
static const struct TrainerMonItemCustomMoves sParty_MayLilycoveTorchic[] = { // May Lilycove
    {
    .iv = 150,
    .lvl = 31,
    .species = SPECIES_TROPIUS,
...
static const struct TrainerMonItemCustomMoves sParty_MaxieMtChimney[] = {
    ...
    .heldItem = ITEM_ROSELI_BERRY,
    .spread = SPREAD_31_IV_60_EV,
    .moves = MOVE_EARTHQUAKE, MOVE_DRAGON_RUSH, MOVE_IRON_TAIL, MOVE_U_TURN
    },
    {
    .lvl = 1,
    .species = SPECIES_KROOKODILE,
    ...
    .ability = 0, // Intimidate
    .spread = SPREAD_31_IV_60_EV,
    .moves = MOVE_CRUNCH, MOVE_EARTHQUAKE, MOVE_COUNTER, MOVE_AQUA_TAIL
    },
    {
    .lvl = 1,
    .species = SPECIES_WEEZING,

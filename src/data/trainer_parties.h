...
static const struct TrainerMonItemCustomMoves sParty_BrendanRoute110Mudkip[] = {
    ...
    .spread = SPREAD_25_IV_0_EV,
    .moves = MOVE_BUG_BITE, MOVE_BUBBLE_BEAM, MOVE_ICE_FANG, MOVE_SPIDER_WEB
    },
    {
    .lvl = -1,
    .species = SPECIES_ARCANINE,
    .spread = SPREAD_25_IV_0_EV,
    .moves = MOVE_FLAME_BURST, MOVE_BITE, MOVE_EXTREME_SPEED, MOVE_ROAR
    },
    {
    .lvl = -1,
    .species = SPECIES_MIMIKYU,
    .spread = SPREAD_25_IV_0_EV,
    .moves = MOVE_SHADOW_CLAW, MOVE_SHADOW_SNEAK, MOVE_HONE_CLAWS, MOVE_SLASH
    },
    {
    .lvl = 1,
    .species = SPECIES_GROVYLE,
...
static const struct TrainerMonItemCustomMoves sParty_BrendanLilycoveTreecko[] = {
    ...
    .moves = MOVE_FLARE_BLITZ, MOVE_HI_JUMP_KICK, MOVE_THUNDER_PUNCH, MOVE_SWORDS_DANCE
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_MayRoute110Mudkip[] = {
    ...
    .ability = 2, // Flame Body
    .spread = SPREAD_25_IV_0_EV,
    .moves = MOVE_BLAZE_KICK, MOVE_TAIL_WHIP, MOVE_TAKE_DOWN, MOVE_DOUBLE_KICK
    },
    {
    .lvl = -1,
    .species = SPECIES_MIMIKYU,
...
static const struct TrainerMonItemCustomMoves sParty_MayRoute110Treecko[] = {
    ...
    .spread = SPREAD_15_IV_0_EV,
    .moves = MOVE_TROP_KICK, MOVE_DOUBLE_KICK, MOVE_U_TURN, MOVE_SYNTHESIS
    },
    {
    .lvl = -1,
    .species = SPECIES_MIMIKYU,
...
static const struct TrainerMonItemCustomMoves sParty_MayRoute119Treecko[] = {
    ...
    .ability = 1, // Queenly Majesty
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_POWER_WHIP, MOVE_HI_JUMP_KICK, MOVE_PLAY_ROUGH, MOVE_STRENGTH
    },
    {
    .lvl = 0,
    .species = SPECIES_MIMIKYU,
...
static const struct TrainerMonItemCustomMoves sParty_MayLilycoveTreecko[] = {
    ...
    .ability = 1, // Queenly Majesty
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_POWER_WHIP, MOVE_HI_JUMP_KICK, MOVE_KNOCK_OFF, MOVE_STRENGTH
    },
    {
    .lvl = 1,
    .species = SPECIES_MIMIKYU,
...
static const struct TrainerMonItemCustomMoves sParty_Cindy3[] = {
    ...
    .heldItem = ITEM_NUGGET,
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_HI_JUMP_KICK, MOVE_RETURN, MOVE_QUICK_ATTACK, MOVE_BABY_DOLL_EYES
    },
    {
    .lvl = -2,
    .species = SPECIES_FURRET,
...
static const struct TrainerMonItemCustomMoves sParty_Cindy4[] = {
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_HI_JUMP_KICK, MOVE_RETURN, MOVE_QUICK_ATTACK, MOVE_U_TURN
    },
    {
    .lvl = -2,
    .species = SPECIES_FURRET,
...
static const struct TrainerMonItemCustomMoves sParty_Edwin1[] = {
    ...
    .spread = SPREAD_10_IV_0_EV,
    .moves = MOVE_FAINT_ATTACK, MOVE_LEAF_BLADE, MOVE_AIR_CUTTER, MOVE_GROWTH
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Miguel1[] = {
    ...
    .spread = SPREAD_10_IV_0_EV,
    .moves = MOVE_FAINT_ATTACK, MOVE_SLASH, MOVE_SCREECH, MOVE_GROWL
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Jasmine[] = {
    ...
    .species = SPECIES_KLINK,
    .spread = SPREAD_15_IV_0_EV,
    .moves = MOVE_GEAR_GRIND, MOVE_SCREECH, MOVE_DISCHARGE, MOVE_VICE_GRIP
    },
    {
    .lvl = -2,
...
static const struct TrainerMonItemCustomMoves sParty_Cora[] = {
    ...
    .species = SPECIES_MEDICHAM,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_HI_JUMP_KICK, MOVE_ZEN_HEADBUTT, MOVE_BULK_UP, MOVE_RECOVER
    },
    {
    .lvl = -3,
    ...
    .heldItem = ITEM_FLYING_GEM,
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_ACROBATICS, MOVE_HI_JUMP_KICK, MOVE_SWORDS_DANCE, MOVE_ROOST
    },
    {
    .lvl = -3,
...
static const struct TrainerMonItemCustomMoves sParty_Isaac1[] = {
    ...
    .spread = SPREAD_31_IV_0_EV,    
    .moves = MOVE_ROCK_SLIDE, MOVE_CURSE, MOVE_FAINT_ATTACK, MOVE_LOW_KICK
    },
    {
    .lvl = -5,
    .species = SPECIES_EEVEE,
    ...
    .spread = SPREAD_31_IV_0_EV,    
    .moves = MOVE_FLAME_BURST, MOVE_SHADOW_BALL, MOVE_ACID_ARMOR, MOVE_POWER_SPLIT
    },
    {
    .lvl = -5,
...
static const struct TrainerMonItemCustomMoves sParty_Melina[] = {
    ...
    .spread = SPREAD_15_IV_0_EV,    
    .moves = MOVE_FAINT_ATTACK, MOVE_ICE_SHARD, MOVE_HONE_CLAWS, MOVE_QUICK_ATTACK
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Courtney1[] = {
    {
    .lvl = 0, 
...
static const struct TrainerMonItemCustomMoves sParty_Marlene[] = {
    ...
    .species = SPECIES_MEDICHAM,
    .spread = SPREAD_25_IV_0_EV,
    .moves = MOVE_ZEN_HEADBUTT, MOVE_HI_JUMP_KICK, MOVE_ICE_PUNCH, MOVE_THUNDER_PUNCH
    },
    {
    .lvl = -3, 
...
static const struct TrainerMonItemCustomMoves sParty_Helene[] = { // Double with Alix
    ...
    .species = SPECIES_TSAREENA,
    .spread = SPREAD_31_IV_60_EV,
    .moves = MOVE_HI_JUMP_KICK, MOVE_POWER_WHIP, MOVE_PLAY_ROUGH, MOVE_PUNISHMENT
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_MaxieMtChimney[] = {
    ...
    .ability = 0, // Levitate
    .spread = SPREAD_31_IV_60_EV,
    .moves = MOVE_SLUDGE_BOMB, MOVE_THUNDERBOLT, MOVE_TOXIC, MOVE_PROTECT
    },
    {
    .lvl = 1,
    .species = SPECIES_VICTREEBEL,
...
static const struct TrainerMonItemCustomMoves sParty_Callie[] = {
    ...
    .species = SPECIES_MEDICHAM,
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_ZEN_HEADBUTT, MOVE_HI_JUMP_KICK, MOVE_RECOVER, MOVE_BULK_UP
    },
    {
    .lvl = -2,
    .species = SPECIES_LOPUNNY,
    .ability = 1, // Scrappy
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_HI_JUMP_KICK, MOVE_RETURN, MOVE_U_TURN, MOVE_BOUNCE
    },
    {
    .lvl = -2,
    .species = SPECIES_MIENSHAO,
    ...
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_HI_JUMP_KICK, MOVE_STONE_EDGE, MOVE_U_TURN, MOVE_KNOCK_OFF
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Myles[] = {
    ...
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_HI_JUMP_KICK, MOVE_CRUNCH, MOVE_BULLET_PUNCH, MOVE_SWORDS_DANCE
    },
    {
    .lvl = -4,
    .species = SPECIES_TOGEKISS,
...
static const struct TrainerMonItemCustomMoves sParty_Zander[] = { // with Leah
    ...
    .species = SPECIES_HITMONLEE,
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_HI_JUMP_KICK, MOVE_KNOCK_OFF, MOVE_BLAZE_KICK, MOVE_FAKE_OUT
    },
    {
    .lvl = -3,
    .species = SPECIES_EMBOAR,
...
static const struct TrainerMonItemCustomMoves sParty_Wendy[] = {
    ...
    .ability = 2, // Reckless
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_HI_JUMP_KICK, MOVE_KNOCK_OFF, MOVE_POISON_JAB, MOVE_BLAZE_KICK
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Grunt41[] = {
    ...
    .species = SPECIES_SCRAFTY,
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_HI_JUMP_KICK, MOVE_CRUNCH, MOVE_POISON_JAB, MOVE_HEAD_SMASH
    },
    {
    .lvl = -1,
    .species = SPECIES_NIDOKING,
...
static const struct TrainerMonItemCustomMoves sParty_MaxieMagmaHideout[] = {
    ...
    .ability = 0, // Drought
    .spread = SPREAD_31_IV_HP_ATK_MIXED,
    .moves = MOVE_PRECIPICE_BLADES, MOVE_HEAT_CRASH, MOVE_SOLAR_BEAM, MOVE_BULK_UP
    },
    {
    .lvl = 1, 
    .species = SPECIES_WEEZING,
    ...
    .ability = 0, // Levitate
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_VENOSHOCK, MOVE_FIRE_BLAST, MOVE_TOXIC, MOVE_PROTECT
    },
    {
    .lvl = 1, 
    .species = SPECIES_HYDREIGON,
    ...
    .ability = 2, // Infiltrator
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SLUDGE_BOMB, MOVE_AIR_SLASH, MOVE_HEAT_WAVE, MOVE_NASTY_PLOT
    },
    {
    .lvl = 1, 
    .species = SPECIES_VICTREEBEL,
...
static const struct TrainerMonItemCustomMoves sParty_Ruben[] = { // Ace
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_HI_JUMP_KICK, MOVE_DOUBLE_EDGE, MOVE_KNOCK_OFF, MOVE_U_TURN
    },
    {
    .lvl = -1,
...
static const struct TrainerMonItemCustomMoves sParty_Kiyo[] = {
    ...
    .species = SPECIES_HAWLUCHA,
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_HI_JUMP_KICK, MOVE_ACROBATICS, MOVE_SWORDS_DANCE, MOVE_FLYING_PRESS
    },
    {
    .lvl = -3,
    .species = SPECIES_PRIMEAPE,
...
static const struct TrainerMonItemCustomMoves sParty_Albert[] = {
    ...
    .ability = 1, // Prankster
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_DOUBLE_EDGE, MOVE_SHADOW_CLAW, MOVE_PLAY_ROUGH, MOVE_WILL_O_WISP
    },
    {
    .lvl = -1,
    .species = SPECIES_WEAVILE,
...
static const struct TrainerMonItemCustomMoves sParty_Quincy[] = { // with Katelynn
    ...
    .ability = 1, // Serene Grace
    .spread = SPREAD_31_IV_HP_SPEED_TIMID,
    .moves = MOVE_AIR_SLASH, MOVE_THUNDER_WAVE, MOVE_ROOST, MOVE_FOLLOW_ME
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .ability = 1, // Moxie
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_KNOCK_OFF, MOVE_HI_JUMP_KICK, MOVE_POISON_JAB, MOVE_DRAGON_DANCE
    },
    {
    .lvl = 2,
    .species = SPECIES_ABSOL,
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .ability = 0, // Mummy
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_WILL_O_WISP, MOVE_HEX, MOVE_AURA_SPHERE, MOVE_TOXIC_SPIKES
    },
    {
    .lvl = 1,
    .species = SPECIES_CHANDELURE,
...
static const struct TrainerMonItemCustomMoves sParty_Lucas2[] = { // Unused
    {
    .lvl = 9,
    .species = SPECIES_WAILMER,
...
static const struct TrainerMonItemCustomMoves sParty_Dudley[] = { // Unused
    {
    .lvl = 33,
    .species = SPECIES_TENTACOOL,
    },

...
static const u8 sBerryDescriptionPart1_Rowap[] = _("People once worked the top-shaped pieces");
static const u8 sBerryDescriptionPart2_Rowap[] = _("of this berry free to use them as toys.");

...
#define BIRCH_INTRO_SPECIES SPECIES_RALTS
...
static void Task_NewGameBirchSpeechSub_InitPokeBall(u8 taskId)
{
    ...
    CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 112, 58, 0, 0, 32, 0x0000FFFF, BIRCH_INTRO_SPECIES);
...
{
    return CreateMonPicSprite_Affine(BIRCH_INTRO_SPECIES, SHINY_ODDS, 0, MON_PIC_AFFINE_FRONT, x, y, 14, TAG_NONE);
}
